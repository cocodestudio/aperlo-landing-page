...
export default function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="grid-pattern" style={{ position: "absolute", inset: 0, opacity: 0.45, zIndex: 0 }} />
      ...
      <div style={{
        ...
        width: 700,
        height: 500,
        background: "radial-gradient(ellipse, rgba(26,107,74,0.07) 0%, transparent 70%)",
        zIndex: 0,
        pointerEvents: "none",
      }} />
      ...
      {/* Main content */}
      <motion.div
        style={{ y: contentY, opacity: contentOpacity, zIndex: 2, width: "100%" }}
      >
        <div style={{
          maxWidth: 880,
          margin: "0 auto",
          ...
          >
            <Image
              ...
              width={52}
              height={52}
              style={{ borderRadius: 14, boxShadow: "0 4px 20px rgba(26,107,74,0.25)" }}
              priority
            />
            <span style={{
          ...
          >
            <motion.a
              href="#"
              id="download"
              whileHover={{ scale: 1.05, boxShadow: "0 12px 40px rgba(26,107,74,0.35)" }}
              whileTap={{ scale: 0.97 }}
              style={{
                display: "flex",
                alignItems: "center",
                ...
                borderRadius: 12,
                textDecoration: "none",
                boxShadow: "0 4px 20px rgba(26,107,74,0.25)",
              }}
            >
              {/* Google Play icon */}
            ...
            <motion.a
              href="#how-it-works"
              whileHover={{ scale: 1.03, background: "var(--surface-muted)" }}
              whileTap={{ scale: 0.97 }}
              style={{
                display: "flex",
                alignItems: "center",
              ...
              >
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 14 }}>
                  {i === 0 ? (
                    ...
                    /* Google Play — official 4-colour triangle */
          ...
          >
            <span style={{
              ...
              Android app ·{" "}
              <span style={{ color: "var(--accent)", fontWeight: 600 }}>Free to download</span>
            </span>
          </motion.div>
      ...
      >
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--ink-muted)" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
